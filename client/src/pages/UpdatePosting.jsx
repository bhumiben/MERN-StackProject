...
export default function CreatePosting() {
    ...
    useEffect(() => {
        const fetchPosting = async () => {
            ...
            const res = await fetch(`/api/posting/get/${postingId}`);
...
const handleSubmit = async (e) => {
    ...
    try{
        ...
        setLoading(true);
        setError(false);
        const res = await fetch(`/api/posting/update/${params.postingId}`, {
            method: 'POST',
            headers: {
        ...
        console.log('Posting ID:', params.postingId);
 ...
 return(
    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            <textarea type="text" placeholder='caption' className='border
            p-3 rounded-lg' id='description' required
            onChange={handleChange} value={formData.description}/>
            <input type="text" placeholder='location' className='border p-3
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                <button 
                    ...
                    className='p-3 textgreen 700 border border-green-700
            ...
            hover:opacity-95 disabled:opacity-80'>
                {loading ? 'Creating...' : 'Update Posting'}
            </button>
